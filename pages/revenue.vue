...
export default {
  ...
  asyncData(context) {
    ...
    const url = `${process.env.apiServerUrl}/api/v1/s/order/revenue_dynamic/day?from=${from}&to=${to}`;
  ...
  methods: {
    getData() {
      ...
      const url = `${process.env.apiServerUrl}/api/v1/s/order/revenue_dynamic/${this.groupBy}?from=${from}&to=${to}`;
