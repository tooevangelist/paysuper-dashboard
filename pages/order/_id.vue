    ...
    <div class="characteristic-container">
        ...
        <div>
            ...
            <dl class="characteristic-group">
                ...
                <dd class="characteristic-value">
                    <span class="characteristic-value-value"
                          v-html="getCommission(order, 'to_payer_fee_amount')"></span>
                </dd>
                <dt class="characteristic-name">
                    <span class="characteristic-name-value">Total commission</span>
                </dt>
                <dd class="characteristic-value">
                    <span class="characteristic-value-value" v-html="getCommission(order, 'project_fee_amount')"></span>
                </dd>
                <dt class="characteristic-name">
        ...
        <div>
            ...
            <dl class="characteristic-group">
                ...
                <dd class="characteristic-value">
                    <span class="characteristic-value-value">
                        {{ order['payer_data']['country_name']['en'] + ', ' + order['payer_data']['city']['en'] }}
                    </span>
                </dd>
            </dl>
        </div>
...
<script>
    ...
    export default {
        ...
        asyncData: function (context) {
            ...
            let url = `${process.env.apiServerUrl}/api/v1/s/order/${context.route['params']['id']}`;
