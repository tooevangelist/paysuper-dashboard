<template>
    <div class="demo-page-container">
        <div class="demo-page-header d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
        ...
        <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
            ...
            <p class="lead">
                The new mount will help you get faster to anywhere in the world, as well as act as a reliable ally in
                any battle.
            </p>
        </div>
        ...
        <div class="container">
                ...
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mt-3 mb-4">
                            ...
                            <li><strong>Combat:</strong> 0</li>
                            <li><strong>Speed:</strong> +20</li>
                            <li><strong>Health:</strong> 289</li>
                        </ul>
                        <button type="button" class="btn btn-lg btn-block btn-outline-primary" @click="buy(5, 'USD')">
                            Buy
                        </button>
                    </div>
                </div>
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mt-3 mb-4">
                            ...
                            <li><strong>Combat:</strong> 3</li>
                            <li><strong>Speed:</strong> +40</li>
                            <li><strong>Health:</strong> 1343</li>
                        </ul>
                        <button type="button" class="btn btn-lg btn-block btn-success" @click="buy(10, 'USD')">Buy
                        </button>
                    </div>
                </div>
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mt-3 mb-4">
                            <li><strong>Level:</strong> 10</li>
                            <li><strong>Combat:</strong> 9</li>
                            <li><strong>Speed:</strong> +80</li>
                            <li><strong>Health:</strong> 3751</li>
                        </ul>
                        <button type="button" class="btn btn-lg btn-block btn-outline-primary" @click="buy(20, 'USD')">
                            Buy
                        </button>
                    </div>
                </div>
            ...
            <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
                ...
                <p class="lead">
                    The pet will not only give you his warmth and affection, but also bestow his unique ones, both in
                ...
                <div class="card-deck mb-3 text-center">
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class="card-body">
                            <h1 class="card-title pricing-card-title">$10</h1>
                            <ul class="list-unstyled mt-3 mb-4">
                                <li><strong>Health:</strong> 283</li>
                                <li><strong>Eats feed:</strong> 12</li>
                                <li>
                                    <strong>Skills:</strong> Create dark matter, Can eat enemy
                                </li>
                            </ul>
                            <button type="button" class="btn btn-lg btn-block btn-outline-primary"
                                    @click="buy(10, 'USD')">Buy
                            </button>
                        </div>
                    </div>
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class="card-body">
                            <h1 class="card-title pricing-card-title">$20</h1>
                            <ul class="list-unstyled mt-3 mb-4">
                                <li><strong>Health:</strong> 567</li>
                                <li><strong>Eats feed:</strong> 24</li>
                                <li>
                                    <strong>Skills:</strong> Healing, Claw, Ink stain
                                </li>
                            </ul>
                            <button type="button" class="btn btn-lg btn-block btn-outline-primary"
                                    @click="buy(20, 'USD')">Buy
                            </button>
                        </div>
                    </div>
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <li><strong>Health:</strong> 1429</li>
                                <li><strong>Eats feed:</strong> 61</li>
                                <li>
                                    <strong>Skills:</strong> Scream, Horn, Armor, Poison
                                </li>
                            </ul>
                            <button type="button" class="btn btn-lg btn-block btn-success" @click="buy(50, 'USD')">Buy
                            </button>
                        </div>
                    </div>
                </div>
