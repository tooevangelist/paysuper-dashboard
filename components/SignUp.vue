        ...
        <div class="login-card">
            ...
            <div class="content">
                <form method="POST" action="#">
                    ...
                    <input id="email" type="email" placeholder="Email" required autofocus v-model="data.email">
                    <input id="password" type="password" placeholder="Password" required v-model="data.password">

                    <div class="row">
                        <div class="col">
                            <div class="form-group form-check">
                                <input type="checkbox" class="form-check-input" id="checkbox" v-model="data.readEula" />
