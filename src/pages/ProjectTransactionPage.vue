...
import ProjectTransactionPageStore from '@/store/ProjectTransactionPageStore';
...
export default {
  ...
  async asyncData({ store, registerStoreModule, route }) {
    try {
      await registerStoreModule('ProjectTransactionPage', ProjectTransactionPageStore, {
  ...
  computed: {
    ...mapState('ProjectTransactionPage', ['transaction', 'refunds']),
  ...
  methods: {
    ...
    ...mapActions('ProjectTransactionPage', ['refund']),
